...
const Main = () => {
    const {bgModal, str, dex, int, activeSouls, soulsFlag, theme, souls, vit, nvl, health, power, nvlPrice, buyVit, buyInt, buyStr, buyDex, setSouls, soulsGain, time, w} = useContext(GameContext)
